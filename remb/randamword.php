...
if (!$db_selected) {
	...
	if(isset($_POST['words']) AND $_POST['words']!='' ){
	$sql="INSERT INTO words SET words='".trim($_POST['words'])."'";
	mysql_query($sql);
	}
...
$totalrec=mysql_query("SELECT count(id) as tot FROM words");
...
<table >
<tr>
	<td><input type="text" name="words" /></td><td><input type="submit" value="save" /></td><td style="font-size:14px; color:#FFFFFF;"><?php  echo $rec->tot; ?></td>
</tr>
...
echo $r[$rs].$saperater; 
//unset($r[$rs]);
if($j==25)echo '<br/><br /><br/>';
if($ib>14){echo '<br/><br />'; $ib=0;}
}
$l=$j;
?>
</td>
...
<a href="randamword.php"><h2><font color="#FFFFFF">Again</h2></a>

<a href="randamword.php?level=<?php echo (++$level);?>"><h2><font color="#FFFFFF">Next</h2></a>
