...
<tr><td align="center" width="100%" style="color:#FFFFFF; font-size:20px;"><h2>Total Number: 90</h2><br /><br /><div id="countdown" ></div></td></tr>
...
<?php echo $r[$i++].$saperater.$r[$i++].$saperater.$r[$i++].$saperater.$r[$i++].$saperater.$r[$i++].$saperater.$r[$i++].$saperater.$r[$i++].$saperater.$r[$i++].$saperater.$r[$i++].$saperater.$r[$i++].$saperater.$r[$i++].$saperater.$r[$i++].$saperater.$r[$i++].$saperater.$r[$i++].$saperater.$r[$i++].$saperater.$r[$i++].$saperater.$r[$i++].$saperater.$r[$i++].$saperater.$r[$i++].$saperater.$r[$i++].$saperater.$r[$i++].$saperater.$r[$i++].$saperater.$r[$i++].$saperater.$r[$i++].$saperater.$r[$i++].$saperater.$r[$i++].$saperater.$r[$i++].$saperater.$r[$i++].$saperater.$r[$i++].$saperater.$r[$i++].$saperater.$saperater.$r[$i++]; ?>
</td>
</tr>
<?php  }?>
