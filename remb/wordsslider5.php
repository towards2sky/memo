	...
	<div id="content">
		...
		<div id="slider">
			...
			<li style="padding-top:10px;"><p style="font-size:<?php echo (120-$l*10); ?>px;" align="center" >Start</p></li>	
					<?php $j=0; $z=1;  foreach($stor as $word){ $z++; $j++; if($j>$t){break;} ?>			
				...
				<?php if($z>2){ $z=1; ?>	
				<li style="padding-top:<?php echo (15+$l); ?>px;"><p style="font-size:<?php echo (120-$l*10); ?>px;" align="center" >.</li>	
				<li style="padding-top:<?php echo (15+$l); ?>px;"><p style="font-size:<?php echo (120-$l*10); ?>px;" align="center" >..</li>	
				<?php }   ?>
				<?php  } ?>	
...
<div id="header">
		...
		<a href="wordsslider5.php?l=<?php echo ++$l; ?>" ><p style="font-size:30px; padding-top:20px; color:#000000" align="center" >Next Level</p></a>
	</div>
