...
$key =$yk.'->'.$m;
?>
<?php $mixdate[$key]=$answer[trim($yearTag[$y])][$m]; ?>
<?php 
}  }?>
...
<input type="hidden" id="a<?php echo $xt.$daykey; ?>" value="<?php echo $mixdate[$daykey]; ?>" />
</td>
<?php 
$ansIds[]=$xt.$daykey;
unset($mixdate[$daykey]);
