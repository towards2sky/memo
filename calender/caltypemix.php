...
<td height="40" style="font-size:14px;" colspan="5">
	...
	<?php for($x=2;$x<15;$x++){ 
	$select = '';
	if($x==$l){$select='selected="selected"';}
...
<tr>
<td width="20%" style="color:#FFFFFF; font-size:18px; font-weight:800; padding-bottom:20px;">Year Tag</td><td width="80%" style="color:#FFFFFF; font-size:18px; font-weight:800;padding-bottom:20px;"  align="center">Start Month of the year</td>
</tr>
